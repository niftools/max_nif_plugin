...
public:
	...
	void*			Create( BOOL loading = FALSE ) {  return new bhkBoxObject( loading ); }
	...
	const TCHAR*	InternalName( ) { return _T( "bhkBox" ); }
...
public:
	...
	BoxParamDlgProc( bhkBoxObject* s )
	{
		so = s;
		thishWnd = NULL;
	}
