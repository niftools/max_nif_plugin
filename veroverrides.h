...
#define MAXVER_INTERNALNAME "EhamPlugin\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "EhamPlugin.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Eham Test Plugin\0"//should  be overidden on a per-dll level
