...
const EnumLookupType BodyPartFlags[] = 
{
   ...
   {BP_HEAD, _T( "Head" ) },
   {BP_HEAD2, _T( "Head 2" ) },
   {BP_LEFTARM, _T( "Left Arm" ) },
   {BP_LEFTARM2, _T( "Left Arm 2" ) },
   {BP_RIGHTARM, _T( "Right Arm" ) },
   {BP_RIGHTARM2, _T( "Right Arm 2" ) },
   {BP_LEFTLEG, _T( "Left Leg" ) },
   {BP_LEFTLEG2, _T( "Left Leg 2" ) },
   {BP_LEFTLEG3, _T( "Left Leg 3" ) },
   {BP_RIGHTLEG, _T( "Right Leg" ) },
   {BP_RIGHTLEG2, _T( "Right Leg 2" ) },
   {BP_RIGHTLEG3, _T( "Right Leg 3" ) },
   {BP_BRAIN, _T( "Brain" ) },
  //SKYRIM
   {BP_SKY_AMULET, _T( "Skyrim amulet" ) },
   {BP_SKY_ARM, _T( "Skyrim arm" ) },
   {BP_SKY_ARM_1, _T( "Skyrim arm1" ) },
   {BP_SKY_BACK, _T( "Skyrim back" ) },
   {BP_SKY_BLOODIED_DRAGON_HEADS, _T( "Skyrim bloodied dragon head" ) },
   {BP_SKY_BLOODIED_DRAGON_HEADS_1, _T( "Skyrim bloodied dragon head 1" ) },
   {BP_SKY_BLOODIED_DRAGON_HEADS_2, _T( "Skyrim bloodied dragon head 2" ) },
   {BP_SKY_BODY, _T( "Skyrim body" ) },
   {BP_SKY_CALVES, _T( "Skyrim calves" ) },
   {BP_SKY_CHEST, _T( "Skyrim chest" ) },
   {BP_SKY_CHEST_1, _T( "Skyrim chest 1" ) },
   {BP_SKY_CIRCLET, _T( "Skyrim circlet" ) },
   {BP_SKY_CIRCLETS_ACCESOARIES, _T( "Skyrim circlet accesoaries" ) },
   {BP_SKY_DECAPITATE, _T( "Skyrim decapitate" ) },
   {BP_SKY_DECAPITATED_HEAD, _T( "Skyrim decapitated head" ) },
   {BP_SKY_DISABLE_EAR_HEADPART, _T( "Skyrim ear headpart" ) },
   {BP_SKY_DISABLE_HAIR_HEADPART, _T( "Skyrim hair headpart" ) },
   {BP_SKY_EARS, _T( "Skyrim ears" ) },
   {BP_SKY_FACE, _T( "Skyrim face" ) },
   {BP_SKY_FACE_MOUTH, _T( "Skyrim mouth" ) },
   {BP_SKY_FEET, _T( "Skyrim feet" ) },
   {BP_SKY_FOREARMS, _T( "Skyrim forearms" ) },
   {BP_SKY_FX01, _T( "Skyrim fx01" ) },
   {BP_SKY_GORE_COVERS_HEAD_NECK, _T( "Skyrim gore covers head and neck" ) },
   {BP_SKY_HAIR, _T( "Skyrim hair" ) },
   {BP_SKY_HAND, _T( "Skyrim hand" ) },
   {BP_SKY_HEAD, _T( "Skyrim Head" ) },
   {BP_SKY_HELMET, _T( "Skyrim helmet" ) },
   {BP_SKY_LEG, _T( "Skyrim leg" ) },
   {BP_SKY_LEG_1, _T( "Skyrim leg 1" ) },
   {BP_SKY_LONG_HAIR, _T( "Skyrim long hair" ) },
   {BP_SKY_MISC_FX, _T( "Skyrim misc fx" ) },
   {BP_SKY_MISC_FX_1, _T( "Skyrim misc fx 1" ) },
   {BP_SKY_NECK, _T( "Skyrim neck" ) },
   {BP_SKY_NECK_DECAPITATION_POINT, _T( "Skyrim neck decapitation" ) },
   {BP_SKY_OPEN_FACE_HELMET, _T( "Skyrim open face helmet" ) },
   {BP_SKY_PELVIS, _T( "Skyrim pelvis" ) },
   {BP_SKY_PELVIS_1, _T( "Skyrim Head" ) },
   {BP_SKY_RING, _T( "Skyrim ring" ) },
   {BP_SKY_SHIELD, _T( "Skyrim shield" ) },
   {BP_SKY_SHOULDER, _T( "Skyrim shoulder" ) },
   {BP_SKY_TAIL, _T( "Skyrim tail" ) },

   {BP_SECTIONCAP_HEAD, _T( "Section Cap | Head" ) },
   {BP_SECTIONCAP_HEAD2, _T( "Section Cap | Head 2" ) },
   {BP_SECTIONCAP_LEFTARM, _T( "Section Cap | Left Arm" ) },
   {BP_SECTIONCAP_LEFTARM2, _T( "Section Cap | Left Arm 2" ) },
   {BP_SECTIONCAP_RIGHTARM, _T( "Section Cap | Right Arm" ) },
   {BP_SECTIONCAP_RIGHTARM2, _T( "Section Cap | Right Arm 2" ) },
   {BP_SECTIONCAP_LEFTLEG, _T( "Section Cap | Left Leg" ) },
   {BP_SECTIONCAP_LEFTLEG2, _T( "Section Cap | Left Leg 2" ) },
   {BP_SECTIONCAP_LEFTLEG3, _T( "Section Cap | Left Leg 3" ) },
   {BP_SECTIONCAP_RIGHTLEG, _T( "Section Cap | Right Leg" ) },
   {BP_SECTIONCAP_RIGHTLEG2, _T( "Section Cap | Right Leg 2" ) },
   {BP_SECTIONCAP_RIGHTLEG3, _T( "Section Cap | Right Leg 3" ) },
   {BP_SECTIONCAP_BRAIN, _T( "Section Cap | Brain" ) },
   {BP_TORSOCAP_HEAD, _T( "Body Cap | Head" ) },
   {BP_TORSOCAP_HEAD2, _T( "Body Cap | Head 2" ) },
   {BP_TORSOCAP_LEFTARM, _T( "Body Cap | Left Arm" ) },
   {BP_TORSOCAP_LEFTARM2, _T( "Body Cap | Left Arm 2" ) },
   {BP_TORSOCAP_RIGHTARM, _T( "Body Cap | Right Arm" ) },
   {BP_TORSOCAP_RIGHTARM2, _T( "Body Cap | Right Arm 2" ) },
   {BP_TORSOCAP_LEFTLEG, _T( "Body Cap | Left Leg" ) },
   {BP_TORSOCAP_LEFTLEG2, _T( "Body Cap | Left Leg 2" ) },
   {BP_TORSOCAP_LEFTLEG3, _T( "Body Cap | Left Leg 3" ) },
   {BP_TORSOCAP_RIGHTLEG, _T( "Body Cap | Right Leg" ) },
   {BP_TORSOCAP_RIGHTLEG2, _T( "Body Cap | Right Leg 2" ) },
   {BP_TORSOCAP_RIGHTLEG3, _T( "Body Cap | Right Leg 3" ) },
   {BP_TORSOCAP_BRAIN, _T( "Body Cap | Brain" ) },
   {BP_TORSOSECTION_HEAD, _T( "Body | Head" ) },
   {BP_TORSOSECTION_HEAD2, _T( "Body | Head 2" ) },
   {BP_TORSOSECTION_LEFTARM, _T( "Body | Left Arm" ) },
   {BP_TORSOSECTION_LEFTARM2, _T( "Body | Left Arm 2" ) },
   {BP_TORSOSECTION_RIGHTARM, _T( "Body | Right Arm" ) },
   {BP_TORSOSECTION_RIGHTARM2, _T( "Body | Right Arm 2" ) },
   {BP_TORSOSECTION_LEFTLEG, _T( "Body | Left Leg" ) },
   {BP_TORSOSECTION_LEFTLEG2, _T( "Body | Left Leg 2" ) },
   {BP_TORSOSECTION_LEFTLEG3, _T( "Body | Left Leg 3" ) },
   {BP_TORSOSECTION_RIGHTLEG, _T( "Body | Right Leg" ) },
   {BP_TORSOSECTION_RIGHTLEG2, _T( "Body | Right Leg 2" ) },
   {BP_TORSOSECTION_RIGHTLEG3, _T( "Body | Right Leg 3" ) },
   {BP_TORSOSECTION_BRAIN, _T( "Body | Brain" ) },
   {0,  NULL },
};
...
public:
	...
	const TSTR& GetName( ) { return name; }
...
const DWORD levelDispFlags[] = 
{
	0,
	DISP_VERTTICKS|DISP_SELVERTS,
	DISP_SELEDGES,
	DISP_SELFACES,
	DISP_SELPOLYS,
	DISP_SELPOLYS
...
void BSDSModifier::ModifyObject( TimeValue t, ModContext& mc, ObjectState* os, INode* node )
{
	...
	if( !d )
		mc.localData = d = new BSDSData( tobj->GetMesh( ) );

	int level = 0;
	if( ip )
		level = ip->GetSubObjectLevel( );
	...
	// TEMP: Copy of LocalDataChanged pasted below with PipeSelLevelChanged removed. As per the 3dsmax SDK help:
	// Note that calling this method from within ModifyObject() is no good since it involves re-evaluating the 
	// pipeline, which will call ModifyObject(), which will the call PipeSelLevelChanged() again, etc.
...
{
	if( theBSDSModifierMainDlgProc.mod != this )
		return;

	if( !BSDSDesc.NumParamMaps( ) )
		return;
...
void BSDSModifier::SetNumSelLabel( )
{
	...
	for( int i = 0; i < list.Count( ); i++ )
	{
		...
		case SEL_VERTEX:
			...
			{
				for( which = 0; which < meshData->GetVertSel( ).GetSize( ); which++ )
					if( meshData->GetVertSel( )[ which ] )
						break;
			}
			break;
		...
		case SEL_ELEMENT:
			...
			{
				for( which = 0; which < meshData->GetFaceSel( ).GetSize( ); which++ )
					if( meshData->GetFaceSel( )[ which ] )
						break;
			}
			break;
		...
		case SEL_EDGE:
			...
			{
				for( which = 0; which < meshData->GetEdgeSel( ).GetSize( ); which++ )
					if( meshData->GetEdgeSel( )[ which ] )
						break;
			}
			break;
		}
...
int BSDSModifier::HitTest( TimeValue t, INode* inode, int type, int crossing, int flags, IPoint2* p, ViewExp* vpt, ModContext* mc )
{
	...
	if( !mc->localData || !( (BSDSData*) mc->localData )->GetMesh( ) )
		return 0;
...
int BSDSModifier::Display( TimeValue t, INode* inode, ViewExp* vpt, int flagst, ModContext* mc )
{
	...
	BitArray fBackfacing;
	BitArray vBackfacing;
	...
	if( backCull )
	{
		...
		for( i = 0; i < mesh->numFaces; i++ )
		{
			...
			for( int j = 0; j < 3; j++ )
				nonIsoVerts.Set( f.v[ j ] );

			if( fBackfacing[ i ] )
				continue;

			for( int j = 0; j < 3; j++ )
				vBackfacing.Clear( f.v[ j ] );
		}
	...
	for( i = 0; i < ect; i++ )
	{
		...
		if( selLevel == SEL_EDGE )
		{
			if( ae->edges[ i ].Selected( mesh->faces, modData->GetEdgeSel( ) ) )
		...
		if( selLevel == SEL_FACE )
		{
			if( ae->edges[ i ].AFaceSelected( modData->GetFaceSel( ) ) )
				gw->setColor( LINE_COLOR, colGizSel );
	...
	if( selLevel == SEL_VERTEX )
	{
		...
		for( i = 0; i < mesh->numVerts; i++ )
		{
			...
			if( getUseVertexDots( ) )
				gw->marker( &( mesh->verts[ i ] ), VERTEX_DOT_MARKER( getVertexDotType( ) ) );

			else
				gw->marker( &( mesh->verts[ i ] ), PLUS_SIGN_MRKR );
...
void BSDSModifier::SelectSubComponent( HitRecord* hitRec, BOOL selected, BOOL all, BOOL invert )
{
	...
	for( nd = 0; nd < mcList.Count( ); nd++ )
	{
		...
		HitRecord* hr = hitRec;
		if( !all && ( hr->modContext->localData != d ) )
			continue;

		for( ; hr != NULL; hr = hr->Next( ) )
		{
			if( hr->modContext->localData == d )
				break;
		}
			...
			if( msci )
			{
				...
				if( selByVert )
				{
					...
					if( selLevel == SEL_ELEMENT )
						...
						pConv->VertexToPolygon( *mesh, af, vhit, nsel, planarThresh, ignoreVisEdge ? true : false );
				}
				else
				{
					BitArray fhit;
					...
					if( selLevel == SEL_ELEMENT )
						...
						pConv->FaceToPolygon( *mesh, af, fhit, nsel, planarThresh, ignoreVisEdge ? true : false );
				}
...
void BSDSModifier::ClearSelection( int selLevel )
{
	...
	for( int i = 0; i < list.Count( ); i++ )
	{
		...
		case SEL_POLY:
		case SEL_ELEMENT:
			if( !d->GetFaceSel( ).NumberSet( ) )
				continue;
			else break;

		case SEL_EDGE:
			if( !d->GetEdgeSel( ).NumberSet( ) )
				continue;
			else break;
		}
...
void BSDSModifier::NotifyInputChanged( Interval changeInt, PartID partID, RefMessage message, ModContext* mc )
{
	...
	if( !ip || ( editMod != this ) || updateCachePosted )
		return;
...
void BSDSModifier::ActivateSubSelSet( int index )
{
	...
	for( int i = 0; i < list.Count( ); i++ )
	{
		...
		if( theHold.Holding( ) && !meshData->held )
			theHold.Put( new SelectRestore( this, meshData ) );
...
IOResult BSDSModifier::SaveLocalData( ISave* isave, LocalModData* ld )
{
	...
	for( int i = 0; i < n; ++i )
	{
		...
		res = isave->Write( (int*) &flag.partFlag, sizeof( int ), &nb );
		res = isave->Write( (int*) &flag.bodyPart, sizeof( int ), &nb );
		res = isave->Write( (int*) &flag.selLevel, sizeof( int ), &nb );
	}
		...
		case PARTFLAGS_CHUNK:
			{
				...
				{
					BSDSPartitionData& flag = d->flags[ i ];
					res = iload->Read( (int*) &flag.partFlag, sizeof( int ), &nb );
					res = iload->Read( (int*) &flag.bodyPart, sizeof( int ), &nb );
					res = iload->Read( (int*) &flag.selLevel, sizeof( int ), &nb );
				}
			}
		}
...
void BSDSData::SynchBitArrays( )
{
	...
	if( GetVertSel( ).GetSize( ) != mesh->getNumVerts( ) )
		GetVertSel( ).SetSize( mesh->getNumVerts( ), TRUE );

	if( GetFaceSel( ).GetSize( ) != mesh->getNumFaces( ) )
		GetFaceSel( ).SetSize( mesh->getNumFaces( ), TRUE );

	if( GetEdgeSel( ).GetSize( ) != mesh->getNumFaces( ) * 3 )
		GetEdgeSel( ).SetSize( mesh->getNumFaces( ) * 3, TRUE );
}
...
void BSDSData::SetActivePartition( DWORD partition )
{
	...
	BitArray empty;
	//empty.SetSize( mesh->getNumFaces( ) );
...
void BSDSData::SetVertSel( int index, BitArray& set, IBSDismemberSkinModifier* imod, TimeValue t )
{
	...
	if( theHold.Holding( ) )
		theHold.Put( new SelectRestore( mod, this, SEL_VERTEX ) );
...
void BSDSData::SetFaceSel( int index, BitArray& set, IBSDismemberSkinModifier* imod, TimeValue t )
{
	BSDSModifier* mod = (BSDSModifier*) imod;
	if( theHold.Holding( ) )
		theHold.Put( new SelectRestore( mod, this, SEL_FACE ) );
...
void BSDSData::SetEdgeSel( int index, BitArray& set, IBSDismemberSkinModifier* imod, TimeValue t )
{
	BSDSModifier* mod = (BSDSModifier*) imod;
	if( theHold.Holding( ) )
		theHold.Put( new SelectRestore( mod, this, SEL_EDGE ) );
...
void BSDSData::SelEdgeByVert( )
{
	...
	for( int i = 0; i < mesh->getNumFaces( ); i++ )
	{
		for( int j = 0; j < 3; j++ )
		{
			...
			if( vertSel[ mesh->faces[ i ].v[ ( j + 1 ) % 3 ] ] )
				edgeSel.Set( i * 3 + j );
		}
	}
}
...
INT_PTR BSDSModifierMainDlgProc::DlgProc( TimeValue t, IParamMap2* map, HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
	...
	case WM_INITDIALOG:
		...
		mAddPart->SetTooltip( TRUE, _T( "Create New Partition" ) );
		...
		mDelPart->SetTooltip( TRUE, _T( "Delete Active Partition" ) );
		...
		but->SetTooltip( TRUE, _T( "Select unused faces into active partition" ) );
		ReleaseICustButton( but );

		but = GetICustButton( GetDlgItem( hWnd, IDC_MS_FIXDUPL ) );
		but->SetTooltip( TRUE, _T( "Remove duplicate faces from partitions" ) );
		ReleaseICustButton( but );
...
SelectRestore::SelectRestore( BSDSModifier* m, BSDSData* data )
{
	...
	case SEL_EDGE: usel = d->GetEdgeSel( ); break;
	case SEL_FACE: usel = d->GetFaceSel( ); break;
	default: usel = d->GetFaceSel( ); break;
	}
}
...
void SelectRestore::Restore( int isUndo )
{
	if( isUndo )
	{
		switch( level )
		{
		case SEL_VERTEX: rsel = d->GetVertSel( ); break;
		case SEL_FACE:
		case SEL_POLY:
		case SEL_ELEMENT: rsel = d->GetFaceSel( ); break;
		case SEL_EDGE: rsel = d->GetEdgeSel( ); break;
		}
	}

	switch( level )
	{
	case SEL_VERTEX: d->GetVertSel( ) = usel; break;
	case SEL_FACE:
	case SEL_POLY:
	case SEL_ELEMENT: d->GetFaceSel( ) = usel; break;
	case SEL_EDGE: d->GetEdgeSel( ) = usel; break;
	}
...
void SelectRestore::Redo( )
{
	switch( level )
	{
	case SEL_VERTEX: d->GetVertSel( ) = rsel; break;
	case SEL_FACE:
	case SEL_POLY:
	case SEL_ELEMENT: d->GetFaceSel( ) = rsel; break;
	case SEL_EDGE: d->GetEdgeSel( ) = rsel; break;
	}
